...
def generate_minio_configs(namespace):
    ...
    minio_configs = {
        ...
        "console_access_key": base64.b64encode(existing_minio_configs["console_access_key"].encode("ascii")).decode("ascii") if "console_access_key" in existing_minio_configs else base64.b64encode(token_urlsafe(16).replace("-", "_").encode("ascii")).decode("ascii"),
        "console_secret_key": base64.b64encode(existing_minio_configs["console_secret_key"].encode("ascii")).decode("ascii") if "console_secret_key" in existing_minio_configs else base64.b64encode(token_urlsafe(16).replace("-", "_").encode("ascii")).decode("ascii")
    }
