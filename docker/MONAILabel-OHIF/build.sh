...
install_dir=${1:-$my_dir/../../monailabel/endpoints/staticINGRESS_PATH/ohif}
mkdir -p ${install_dir}
...
yarn install
APP_CONFIG=config/monai_label.js PUBLIC_URL=INGRESS_PATH/ohif/ QUICK_BUILD=true yarn run build
